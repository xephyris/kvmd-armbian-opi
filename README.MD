...
# Tested device
 ...
 - Nano Pi Neo, Libre Computer ALL-H3-CC H5 2GB, Rock64, Orange Pi Zero Plus, and LaFrite 1GB (tested by @srepac)
 - Libre Computer Le Potato and Inovato Quadra tv box (tested by @srepac)
